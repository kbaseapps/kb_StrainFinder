...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_StrainFinder'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_StrainFinder.kb_StrainFinderImpl import kb_StrainFinder  # noqa @IgnorePep8
impl_kb_StrainFinder = kb_StrainFinder(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_StrainFinder'
